...
\begin{center}
    \begin{minipage}[b]{0.49\columnwidth}
        \centering
        \subfloat[Legend \label{fig:llm_legend}]{\includegraphics[width=\textwidth]{figures/llm_legend.pdf}} \vspace{1em}
        \subfloat[Few-shot learning \label{fig:llm_fsl}]{\includegraphics[width=\textwidth]{figures/llm_fsl.pdf}}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{.49\columnwidth}
        \centering
        \subfloat[Retrieval Augmented Gen. \label{fig:llm_rag}]{\includegraphics[width=\textwidth]{figures/llm_rag.pdf}} \vspace{1em}
        \subfloat[Chain-of-Thoughts reasoning \label{fig:llm_cot}]{\includegraphics[width=\textwidth]{figures/llm_cot.pdf}}
    \end{minipage}
...
\begin{figure}[!ht]
\begin{center}
    % \subfloat[Legend \label{fig:llm_legend}]{\includegraphics[width=.972\columnwidth]{figures/llm_legend.pdf}} \\
    \subfloat[Legend \label{fig:llm_legend}]{\includegraphics[width=.729\columnwidth]{figures/llm_legend.pdf}} \\
    % \subfloat[Few-shot learning \label{fig:llm_fsl}]{\includegraphics[width=.321\columnwidth]{figures/llm_fsl.pdf}} \hfill
    % \hspace{5em}
    \subfloat[Few-shot learning \label{fig:llm_fsl}]{\includegraphics[width=.24075\columnwidth]{figures/llm_fsl.pdf}} \hfill
    % \subfloat[RAG\label{fig:llm_rag}]{\includegraphics[width=.1605\columnwidth]{figures/llm_rag.pdf}} \hfill
    \subfloat[RAG\label{fig:llm_rag}]{\includegraphics[width=.24075\columnwidth]{figures/llm_rag.pdf}} \hfill
    % \subfloat[CoT reasoning \label{fig:llm_cot}]{\includegraphics[width=.321\columnwidth]{figures/llm_cot.pdf}}
    \subfloat[CoT reasoning \label{fig:llm_cot}]{\includegraphics[width=.24075\columnwidth]{figures/llm_cot.pdf}} % \hspace{5em}
...
\begin{center}
    ...
    \includegraphics[width=.755\columnwidth]{figures/idea2.pdf}
...
\begin{figure}[!h]
\begin{center}
    % \subfloat[Semi-structured use case: knowledge grounded chat.\label{fig:ssuc}]{\includegraphics[width=\columnwidth]{figures/ssuc.pdf}} \hfill
    \subfloat[Semi-structured use case: knowledge grounded chat.\label{fig:ssuc}]{\includegraphics[width=.6\columnwidth]{figures/ssuc.pdf}} \\
    % \subfloat[Structured use case: database creation\label{fig:suc}]{\includegraphics[width=\columnwidth]{figures/suc.pdf}}
    \subfloat[Structured use case: database creation\label{fig:suc}]{\includegraphics[width=.6\columnwidth]{figures/suc.pdf}}
...
\begin{figure}
    \centering
    \subfloat[Question 1.\label{fig:q1}]{\includegraphics[width=.48\columnwidth]{figures/q1_llm_experience.pdf}} \hfill
    \subfloat[Question 2.\label{fig:q2}]{\includegraphics[width=.48\columnwidth]{figures/q2_role.pdf}} \\
    \subfloat[Question 3.\label{fig:q3}]{\includegraphics[width=.48\columnwidth]{figures/q3_years_experience.pdf}} \hfill
    \subfloat[Question 4.\label{fig:q4}]{\includegraphics[width=.48\columnwidth]{figures/q4_knowledgeability.pdf}}
...
\begin{figure}
    \centering
    \subfloat[Question 5.\label{fig:q5}]{\includegraphics[width=.48\columnwidth]{figures/q5_implementation_methods.pdf}} \hfill
    \subfloat[Question 6.\label{fig:q6}]{\includegraphics[width=.48\columnwidth]{figures/q6_prompt_location.pdf}}
...
\begin{figure}
    \centering
    \subfloat[Question 10\label{fig:q10}]{\includegraphics[width=.72\columnwidth]{figures/q10_overall_dsl_usefulness.pdf}} \\
    \subfloat[Question 11\label{fig:q11}]{\includegraphics[width=.72\columnwidth]{figures/q11_dsl_benefits.pdf}} \\
    \subfloat[Question 12\label{fig:q12}]{\includegraphics[width=.72\columnwidth]{figures/q12_adoption_concerns.pdf}}
