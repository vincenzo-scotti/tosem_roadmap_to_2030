...
\begin{figure}
    \centering
    \subfloat[Question 1.\label{fig:q1}]{\includegraphics[width=.25\columnwidth]{figures/q1_llm_experience.pdf}} \hfill
    \subfloat[Question 2.\label{fig:q2}]{\includegraphics[width=.25\columnwidth]{figures/q2_role.pdf}} \\
    \subfloat[Question 3.\label{fig:q3}]{\includegraphics[width=.25\columnwidth]{figures/q3_years_experience.pdf}} \hfill
    \subfloat[Question 4.\label{fig:q4}]{\includegraphics[width=.25\columnwidth]{figures/q4_knowledgeability.pdf}}
    \caption{Screen and background section responses.}
    \label{fig:sec1}
\end{figure}

\begin{figure}
    \centering
    \subfloat[Question 5.\label{fig:q5}]{\includegraphics[width=.25\columnwidth]{figures/q5_implementation_methods.pdf}} \hfill
    \subfloat[Question 6.\label{fig:q6}]{\includegraphics[width=.25\columnwidth]{figures/q6_prompt_location.pdf}}
...
\begin{figure}
    \centering
    \includegraphics[width=.75\columnwidth]{figures/q7_pain_points.pdf}
    \caption{Current practice section responses - Question 7.}
    \label{fig:sec3}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=.75\columnwidth]{figures/q9_feature_usefulness.pdf}
...
\begin{figure}
    \centering
    \subfloat[Question 10\label{fig:q10}]{\includegraphics[width=.75\columnwidth]{figures/q10_overall_dsl_usefulness.pdf}} \\
    \subfloat[Question 11\label{fig:q11}]{\includegraphics[width=.75\columnwidth]{figures/q11_dsl_benefits.pdf}} \\
    \subfloat[Question 12\label{fig:q12}]{\includegraphics[width=.75\columnwidth]{figures/q12_adoption_concerns.pdf}}
