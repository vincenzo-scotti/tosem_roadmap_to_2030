...
To analyze differences in perceived alignment across the responding roles, we employed a Friedman test to determine whether statistically significant differences exist at the group level, followed by post-hoc pairwise Wilcoxon signed-rank tests comparing the specialized roles against the generic \texttt{contributor} baseline.
